        ...
        >
            <div className="relative w-full md:w-96">
                <input
                    ...
                    className="w-full pl-10 pr-4 py-1.5 rounded-lg bg-blue-800/7 border border-gray-300/45 focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-400"
                />
                <button
                    type="submit"
